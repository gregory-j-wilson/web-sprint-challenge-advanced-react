...
1. Explain how to build stateful class components.
    ...
    CCR - You extend React.Component (write the class) and then write constructor function, which includes super() and establishing the state, and then you render later on.

2. Describe the different phases of the component lifecycle.

    Mounting - the component mounts to screen , Updating - component gets changed, Unmounting - component dies and goes away

3. Demonstrate an understanding of class component lifecycle methods.

    componentDidMount functions like a useEffect, where when the component mounts, state can be updated etc..
    componentDidUpdate gives a chance to modify DOM when the component updates
    componentWillUnmount is things that happen right before the component unmounts - like cleanup - disabling things.

4. Define stateful logic.

  this is logic that has to do with the state - like handling changes or handling submit

5. Describe how to test a React component with React Testing Library.

  Arrange - set up our code so it can be tested
  Act - call a method or function that returns a result of interest to our test.
  Assert - assert if our epected return matched the actual return
